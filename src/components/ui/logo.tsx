...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  const OptiFlowLogo = ({ className: logoClassName = '' }: { className?: string }) => (
    ...
    >
      {/* Background */}
      <rect width="1024" height="256" fill="#000000"/>
      
      {/* "Opti" em verde */}
      <text x="50" y="180" fontSize="120" fontWeight="bold" fill="#00D26A" fontFamily="Arial, sans-serif">
        Opti
      </text>
      
      {/* "Flow" em cinza */}
      <text x="350" y="180" fontSize="120" fontWeight="bold" fill="#6B7280" fontFamily="Arial, sans-serif">
        Flow
      </text>
      
      {/* "VAREJO" em verde menor */}
      <text x="850" y="80" fontSize="32" fontWeight="600" fill="#00D26A" fontFamily="Arial, sans-serif" letterSpacing="2px">
        VAREJO
      </text>
    </svg>
  );
